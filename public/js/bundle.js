        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://localhost:7777/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://localhost:7777/api/v1/users/logout');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmluaHRoYWl0cmluaCIsImEiOiJja2Fmd3N4ZmQwMGl5MnByczRpemNtbmJuIn0.xnfYgxJS0A43UirFkTOgfg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:7777/api/v1/users/".concat(url),
              data: data
            });
...
var stripe = Stripe('pk_test_YiOh5ItHZIRxn3YmLz5m1p8M00s23G9fRg');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:7777/api/v1/bookings/checkout-session/".concat(tourId));
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // get from data-tour-id
